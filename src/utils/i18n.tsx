...
const translations: Record<Language, TranslationData> = {
  ...
  ar: {
    ...
    wallet: {
      title: 'محفظتي',
      managePayment: 'إدارة طرق الدفع والأرصدة الخاصة بك',
      credits: 'الرصيد',
      equity: 'الحقوق',
      forSkillSwaps: 'لتبادل المهارات',
      fromInvestments: 'من استثماراتك',
      paymentMethods: 'طرق الدفع',
      savedCards: 'البطاقات المحفوظة',
      savedPaymentMethods: 'طرق الدفع المحفوظة',
      manageCards: 'إضافة وإدارة بطاقاتك الائتمانية',
      addCard: 'إضافة بطاقة',
      addNewCard: 'إضافة بطاقة جديدة',
      cardSecure: 'معلومات بطاقتك آمنة ومشفرة',
      ...
      cardRemoved: 'تمت إزالة البطاقة بنجاح',
      noPaymentMethods: 'لا توجد طرق دفع بعد',
      addCardToStart: 'أضف بطاقة ائتمان لبدء الدفع',
      addFirstCard: 'أضف بطاقتك الأولى',
      security: 'الأمان',
      encrypted: 'تشفير بمستوى البنوك',
      encryptedDesc: 'جميع البيانات مشفرة بـ SSL 256 بت',
      pciCompliant: 'متوافق مع PCI DSS',
      pciCompliantDesc: 'نحن نلبي جميع معايير الأمان',
      neverStored: 'CVV لا يتم تخزينه أبداً',
      neverStoredDesc: 'لا يتم حفظ CVV الخاص بك على خوادمنا',
      topUp: 'إضافة رصيد',
